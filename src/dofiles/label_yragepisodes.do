use "#datafile#", clear
compress
label data "#node# Exposure Episodes by Calendar Year and Age V#version#"
...
label var CalendarYear "Calendar year during episode"
label var Age "Age in completed years during episode"
